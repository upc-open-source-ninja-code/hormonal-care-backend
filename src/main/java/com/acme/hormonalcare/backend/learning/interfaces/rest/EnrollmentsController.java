...
import com.acme.hormonalcare.backend.learning.domain.model.commands.CancelEnrollmentCommand;
import com.acme.hormonalcare.backend.learning.domain.model.commands.ConfirmEnrollmentCommand;
import com.acme.hormonalcare.backend.learning.domain.model.commands.RejectEnrollmentCommand;
import com.acme.hormonalcare.backend.learning.domain.model.queries.GetAllEnrollmentsQuery;
import com.acme.hormonalcare.backend.learning.domain.model.queries.GetEnrollmentByAcmeStudentRecordIdAndCourseIdQuery;
import com.acme.hormonalcare.backend.learning.domain.model.valueobjects.AcmeStudentRecordId;
import com.acme.hormonalcare.backend.learning.domain.services.EnrollmentCommandService;
import com.acme.hormonalcare.backend.learning.domain.services.EnrollmentQueryService;
import com.acme.hormonalcare.backend.learning.interfaces.rest.resources.EnrollmentResource;
import com.acme.hormonalcare.backend.learning.interfaces.rest.resources.RequestEnrollmentResource;
import com.acme.hormonalcare.backend.learning.interfaces.rest.transform.EnrollmentResourceFromEntityAssembler;
import com.acme.hormonalcare.backend.learning.interfaces.rest.transform.RequestEnrollmentCommandFromResourceAssembler;
import com.acme.hormonalcare.backend.shared.interfaces.rest.resources.MessageResource;
