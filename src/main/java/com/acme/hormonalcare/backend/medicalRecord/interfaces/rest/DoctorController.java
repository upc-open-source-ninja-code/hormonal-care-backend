...
public class DoctorController {
    ...
    public ResponseEntity<DoctorResource> updateDoctorSubscription(@PathVariable Long doctorId, @RequestBody String subscription){
    ...
    public ResponseEntity<DoctorResource> updateDoctorAppointmentFee(@PathVariable Long doctorId, @RequestBody String appointmentFee){
